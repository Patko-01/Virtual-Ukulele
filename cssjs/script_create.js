...
let output_clipboard_song = "";
let output_clipboard_notes = "";
let output_clipboard_breaks = "";
...
function myFunction(){
  navigator.clipboard.writeText(output_clipboard_song);
}
function myFunction1(){
  navigator.clipboard.writeText(output_clipboard_notes);
}
